...
type usersishidaisseiblogterribleByGatsbysrccomponentsseoTsx2841359383Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
      Pick<SiteSiteMetadata, 'title' | 'description'>
      & { readonly social: Maybe<Pick<Social, 'twitter'>> }
    )> }> };

type usersishidaisseiblogterribleByGatsbysrcpagesusingTypescriptTsx2907560070QueryVariables = Exact<{ [key: string]: never; }>;
